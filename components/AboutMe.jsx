            ...
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-8 md:px-32 py-16 xl-gap-16 items-center">
                ...
                <div className="mt-4 mx-10 lg:mx-0 md:mt-0 text-left flex flex-col h-full">
                    ...
                    <p className="text-base text-justify lg:text-lg">
                        ...
                        My passion for technology and problem-solving has led me to voluntarily participate in more hackathons in the future, where I primarily serve as a Front End Developer, and Part time Artist. However, I am not limited to frontend tasks and often take on backend responsibilities, demonstrating my versatility and commitment to delivering complete solutions. </p>
